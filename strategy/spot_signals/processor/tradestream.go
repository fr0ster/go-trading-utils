...
import (
	...
	binance_trade "github.com/fr0ster/go-trading-utils/binance/spot/markets/trade"
...
func (pp *PairProcessor) startTradeStream(
	...
	doneC, stopC, err = binance.WsAggTradeServe(pp.symbol.Symbol, handler, errHandler)
	return
}

func (pp *PairProcessor) TradeEventStart(
	stop chan struct{},
	callBack binance.WsAggTradeHandler) (
...
func (pp *PairProcessor) GetAggTradesHandler(limit int, trade *trade_types.AggTrades) binance.WsAggTradeHandler {
	binance_trade.AggTradeInit(trade, pp.client, pp.GetPair(), limit)
