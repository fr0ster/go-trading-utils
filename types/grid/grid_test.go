...
func TestGridOverTree(t *testing.T) {
	...
	tree.Set(grid.NewLine(1, 10.5, 15.5, 0))
	tree.Set(grid.NewLine(4, 15.5, 20.5, 10.5))
	tree.Set(grid.NewLine(7, 20.5, 25.5, 15.5))
	tree.Set(grid.NewLine(10, 25.5, 30.5, 20.5))
	tree.Set(grid.NewLine(13, 30.5, 35.5, 25.5))
	tree.Set(grid.NewLine(16, 35.5, 0, 30.5))
