...
// // Відбираємо по сумі
// func (d *Depths) GetAsksBidMaxAndSummaByQuantity(targetSummaAsk, targetSummaBid types.QuantityType, firstMax ...bool) (
// 	asks,
...
// func (d *Depths) GetAsksBidMaxAndSummaByQuantityPercent(targetPercentAsk, targetPercentBid float64) (
// 	asks,
// 	bids *types.DepthItem,
// 	summaAsks,
// 	summaBids types.QuantityType,
