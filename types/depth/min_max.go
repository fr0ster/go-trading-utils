...
// func (d *Depths) AddAskMinMax(price types.PriceType, quantity types.QuantityType) {
// 	if d.asksMinMax != nil {
...
// func (d *Depths) DeleteAskMinMax(price types.PriceType, quantity types.QuantityType) {
// 	if d.asksMinMax != nil {
// 		if old := d.asksMinMax.Get(d.NewQuantityItem(quantity)); old != nil {
...
// func (d *Depths) AddBidMinMax(price types.PriceType, quantity types.QuantityType) {
// 	if d.bidsMinMax != nil {
...
// func (d *Depths) DeleteBidMinMax(price types.PriceType, quantity types.QuantityType) {
// 	if d.bidsMinMax != nil {
// 		if old := d.bidsMinMax.Get(d.NewQuantityItem(quantity)); old != nil {
// 			old.(*types.QuantityItem).Delete(price, quantity)
// 			if old.(*types.QuantityItem).IsShouldDelete() {
...
// func (d *Depths) AskMin() (min *types.DepthItem, err error) {
// 	if d.asksMinMax == nil {
...
// func (d *Depths) AskMax() (max *types.DepthItem, err error) {
// 	if d.asksMinMax == nil {
// 		err = errors.New("asksMinMax is empty")
// 		return
// 	}
...
// func (d *Depths) BidMin() (min *types.DepthItem, err error) {
// 	if d.bidsMinMax == nil {
...
// func (d *Depths) BidMax() (max *types.DepthItem, err error) {
// 	if d.bidsMinMax == nil {
// 		err = errors.New("bidsMinMax is empty")
// 		return
// 	}
...
// func (d *Depths) NewQuantityItem(quantity types.QuantityType, price ...types.PriceType) *types.QuantityItem {
// 	if len(price) > 0 {
