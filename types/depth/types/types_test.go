...
func TestGetNormalizedPrice(t *testing.T) {
	...
	price = types.NewNormalizedItem(1.552, 3, -1, false).GetNormalizedPrice()
	assert.Equal(t, types.PriceType(1.5), price)
	price = types.NewNormalizedItem(1.941, 3, -1, false).GetNormalizedPrice()
	assert.Equal(t, types.PriceType(1.9), price)
	price = types.NewNormalizedItem(80, 3, 1, false).GetNormalizedPrice()
	assert.Equal(t, types.PriceType(80.0), price)
	price = types.NewNormalizedItem(45.5, 3, 0, false).GetNormalizedPrice()
	...
	price = types.NewNormalizedItem(1.552, 3, -1, true).GetNormalizedPrice()
	assert.Equal(t, types.PriceType(1.6), price)
	price = types.NewNormalizedItem(1.941, 3, 0, true).GetNormalizedPrice()
