...
func TestGetTargetAsksBidPrice(t *testing.T) {
	...
	func() {
		asks, summaAsks := d.GetAsks().GetDepths().GetMaxAndSummaByQuantity(
			d.GetAsks().GetDepths().GetSummaQuantity()*items_types.QuantityType(0.3), true)
		bids, summaBids := d.GetBids().GetDepths().GetMaxAndSummaByQuantity(
			d.GetBids().GetDepths().GetSummaQuantity()*items_types.QuantityType(0.3), false)
	...
	func() {
		asks, summaAsks := d.GetAsks().GetDepths().GetMaxAndSummaByQuantity(d.GetAsks().GetDepths().GetSummaQuantity()*items_types.QuantityType(0.3), true)
		bids, summaBids := d.GetBids().GetDepths().GetMaxAndSummaByQuantity(d.GetBids().GetDepths().GetSummaQuantity()*items_types.QuantityType(0.3), true)
		assert.NotNil(t, asks)
		assert.NotNil(t, bids)
		assert.Equal(t, items_types.PriceType(600.0), asks.GetPrice())
		assert.Equal(t, items_types.QuantityType(10.0), summaAsks)
...
func TestGetAsksAndBidSummaAndRange(t *testing.T) {
	...
	assert.Equal(t, items_types.QuantityType(90.0), d.GetBids().GetDepths().GetSummaQuantity())
	func() {
		maxAsk1, summaAsks1 := d.GetAsks().GetDepths().GetMaxAndSummaByQuantity(40, true)
		maxBid1, summaBids1 := d.GetBids().GetDepths().GetMaxAndSummaByQuantity(40, false)
		...
		maxAsk3, summaAsks3 := d.GetAsks().GetDepths().GetMaxAndSummaByQuantity(85.0, true)
		maxBid3, summaBids3 := d.GetBids().GetDepths().GetMaxAndSummaByQuantity(85.0, false)
	...
	func() {
		maxAsk1, summaAsks1 := d.GetAsks().GetDepths().GetMaxAndSummaByPrice(700.0, true)
		maxBid1, summaBids1 := d.GetBids().GetDepths().GetMaxAndSummaByPrice(400.0, false)
		assert.Equal(t, items_types.PriceType(700.0), maxAsk1.GetPrice())
		assert.Equal(t, items_types.QuantityType(20.0), maxAsk1.GetQuantity())
		assert.Equal(t, items_types.QuantityType(30.0), summaAsks1)
		assert.Equal(t, items_types.PriceType(400.0), maxBid1.GetPrice())
		assert.Equal(t, items_types.QuantityType(20.0), maxBid1.GetQuantity())
		assert.Equal(t, items_types.QuantityType(30.0), summaBids1)
		maxAsk3, summaAsks3 := d.GetAsks().GetDepths().GetMaxAndSummaByPrice(850.0, true)
		maxBid3, summaBids3 := d.GetBids().GetDepths().GetMaxAndSummaByPrice(250.0, false)
...
func TestGetTargetAsksBidPriceAndRange(t *testing.T) {
	...
	assert.Equal(t, items_types.QuantityType(90.0), d.GetAsks().GetDepths().GetSummaQuantity())
	assert.Equal(t, items_types.QuantityType(90.0), d.GetBids().GetDepths().GetSummaQuantity())
	ask1, summaAsks1 := d.GetAsks().GetDepths().GetMaxAndSummaByQuantity(20, true)
	bid1, summaBids1 := d.GetBids().GetDepths().GetMaxAndSummaByQuantity(20, false)
	ask2, summaAsks3 := d.GetAsks().GetDepths().GetMaxAndSummaByQuantity(50, true)
	bid2, summaBids3 := d.GetBids().GetDepths().GetMaxAndSummaByQuantity(50, false)
...
// 		assert.Equal(t, items_types.PriceType(800.0), askNorm1.GetNormalizedPrice())
// 		assert.Equal(t, items_types.QuantityType(250.0), askNorm1.GetQuantity())
// 		ds.DeleteAsk(800)
// 		askNorm1, _ = ds.GetNormalizedAsk(800)
// 		assert.Equal(t, items_types.PriceType(800.0), askNorm1.GetNormalizedPrice())
// 		assert.Equal(t, items_types.QuantityType(150.0), askNorm1.GetQuantity())
// 	}()
// 	func() {
// 		asks, bids := getTestDepths()
// 		ds := depth_types.New(degree, "DOGEUSDT", true, 10, 100, -1, depths_types.DepthStreamRate100ms)
// 		ds.SetAsks(asks)
// 		ds.SetBids(bids)
// 		askNorm1, _ := ds.GetNormalizedAsk(1.953)
// 		assert.Equal(t, items_types.PriceType(2.0), askNorm1.GetNormalizedPrice())
// 		assert.Equal(t, items_types.QuantityType(1186.7), askNorm1.GetQuantity())
// 	}()
// }
...
// 	ds := depth_types.New(degree, "BTCUSDT", true, 10, 100, 2, depths_types.DepthStreamRate100ms)
// 	testSetAsk := func(price items_types.PriceType, quantity items_types.QuantityType) (summa, summaTest, summaTest2 items_types.QuantityType) {
...
// 	assert.Equal(t, items_types.QuantityType(100), summa)
// 	assert.Equal(t, items_types.QuantityType(100), summaTest)
// 	assert.Equal(t, items_types.QuantityType(100), summaTest2)
// 	summa, summaTest, summaTest2 = testSetAsk(750, 100)
// 	assert.Equal(t, items_types.QuantityType(200), summa)
// 	assert.Equal(t, items_types.QuantityType(200), summaTest)
// 	assert.Equal(t, items_types.QuantityType(200), summaTest2)
...
// 	summaAsks2 := items_types.QuantityType(0)
// 	ds.GetAsks().Ascend(func(i btree.Item) bool {
// 		summaAsks2 += i.(*items_types.DepthItem).GetQuantity()
// 		return true
// 	})
// 	assert.Equal(t, summaAsks1, summaAsks2)
// 	summaAsks3 := items_types.QuantityType(0)
// 	ds.GetNormalizedAsks().Ascend(func(i btree.Item) bool {
// 		summaAsks3 += i.(*items_types.NormalizedItem).GetQuantity()
// 		return true
// 	})
// 	assert.Equal(t, summaAsks1, summaAsks3)
// 	assert.Equal(t, summaAsks2, summaAsks1)

// 	testDeleteAsk := func(price items_types.PriceType) (askN *items_types.NormalizedItem, summa, summaTest, summaTest2 items_types.QuantityType) {
// 		ds.DeleteAsk(price)
// 		askN, _ = ds.GetNormalizedAsk(price)
// 		summaTest, summaTest2 = ds.GetNormalizedAskSumma(price)
// 		if askN != nil {
...
// 	assert.Nil(t, askN)
// 	assert.Equal(t, items_types.QuantityType(0), summa)
// 	assert.Equal(t, items_types.QuantityType(0), summaTest)
// 	assert.Equal(t, items_types.QuantityType(0), summaTest2)
