...
func CallBackCreator(
	handlers ...func(d *orders_types.Orders) futures.WsDepthHandler) func(d *orders_types.Orders) futures.WsDepthHandler {
	return func(d *orders_types.Orders) futures.WsDepthHandler {
